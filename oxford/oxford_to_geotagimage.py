...
def main():
    ...
    for date, rtk_date in zip(date_list, rtk_date_list):
        ...
        output_prefix = os.path.join(dataset_root_dir, 'icrca')
        ...
        cam_timestamp_dir = [front_cam_timestamp]
        ...
        position_names = ['front']
        output_list = [front_output]
        save_list = [front_save_list]
        postfix_list = [front_post_fix]
